...
import type { ICreatePersonRequest } from "../components/Interfaces/ICreatePersonRequest";
import type { ICreatePersonResponse } from "../components/Interfaces/ICreatePersonResponse";
