...
const operationLinks = [
  { link: "/financial/operations/requisitions", label: "Requisição de Material", icon: IconReportMoney },
];
...
export function FinancialNavigation() {
  ...
  return (
    <Box p="md">
      ...
      <Text size="xs" fw={700} c="dimmed" tt="uppercase" mt="xl" mb="md" pl="sm" style={{ letterSpacing: 1 }}>
        Operações
      </Text>
