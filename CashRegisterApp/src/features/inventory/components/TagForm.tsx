import { Button, Center, Grid, Paper, Title, Stack, ColorInput as MantineColorInput } from "@mantine/core";
...
function ColorInputForm({ name, label, placeholder }: { name: string, label: string, placeholder?: string }) {
    ...
    <Controller
      ...
      render={({ field, fieldState: { error } }) => (
        <MantineColorInput
          ...
          error={error?.message}
          format="hex"
          swatches={['#2e2e2e', '#868e96', '#fa5252', '#e64980', '#be4bdb', '#7950f2', '#4c6ef5', '#228be6', '#15aabf', '#12b886', '#20c997', '#40c057', '#82c91e', '#fab005', '#fd7e14', '#e67700', '#d9480f']}
        />
      )}
    />
  );
